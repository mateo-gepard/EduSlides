            ...
            {events.map((ev, i) => (
              ...
              >
                <div
                  ...
                  style={{ borderColor: ev.color, background: `${ev.color}25` }}
                />
                ...
                <div className="flex items-center gap-2 mb-1.5">
                  ...
                  >
                    <SlideIcon name={ev.icon} size={12} color={ev.color} />
                    {ev.time}
                  </span>
                </div>

                <h3 className="text-sm font-bold text-slate-800 mb-1">{ev.title}</h3>
      ...
      {content.sideChart && (
        ...
        >
          ...
          {content.sideChart.source && (
            <p className="text-[10px] text-slate-400 mb-4">{content.sideChart.source}</p>
          )}
            ...
            {content.sideChart.bars.map((bar, i) => (
              ...
              >
                <div className="flex items-center justify-between text-xs mb-1">
                  ...
                  <span className="font-mono text-slate-700">{bar.displayValue}</span>
                </div>
